...
public static class PERMUT2
{
    public static bool Solve(int[] permutation)
    {
        ...
        // permutation, where it's telling us the value 1 is at index 5, the value 2 is
        // at index 1, and so on. The permutation is ambiguous if the permutation and the
        // inverse permutation are equal.
