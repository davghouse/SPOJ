...
public static class AE00
{
    public static int Solve(int n)
    {
        ...
        // can make (recursively) as many rectangles as n - 1 squares make, plus however
        // many rectangles from exactly n squares. So we'll keep a cumulative count of
        // rectangles made from s = 1 squares up to s = n squares.
